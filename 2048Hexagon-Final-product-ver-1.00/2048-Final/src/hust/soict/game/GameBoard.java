...
public class GameBoard {
	...
	public static final int ROWS = Setting.SIZE;
	public static final int COLS = Setting.SIZE;
	...
	private int boardColor = Setting.ShiftColor_board;
	...
	private void createBoardImage() {
		...
		g.setColor(new Color(0x5a5a5a + boardColor));
		g.fillRect(0, 0, BOARD_WIDTH, BOARD_HEIGHT);
		g.setColor(new Color(0xd3d3d3 + boardColor));
