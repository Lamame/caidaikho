...
public class Tile {
	...
	private void drawImage() {
		...
		if (value == 2) {
			background = new Color(0xe9e9e9 + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() < 0x7fffff ?  0x000000 :0xffffff);
		}
		else if (value == 4) {
			background = new Color(0xe6daab + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() < 0x7fffff ?  0x000000 :0xffffff);
		}
		else if (value == 8) {
			background = new Color(0xf79d3d + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() < 0x7fffff ?  0x000000 :0xffffff);
		}
		else if (value == 16) {
			background = new Color(0xf28007 + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() < 0x7fffff ?  0x000000 :0xffffff);
		}
		else if (value == 32) {
			background = new Color(0xf55e3b + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() < 0x7fffff ?  0x000000 :0xffffff);
		}
		else if (value == 64) {
			background = new Color(0xff0000 + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() < 0x7fffff ?  0x000000 :0xffffff);
		}
		else if (value == 128) {
			background = new Color(0xe9de84 + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() < 0x7fffff ?  0x000000 :0xffffff);
		}
		else if (value == 256) {
			background = new Color(0xf6e873 + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() < 0x7fffff ?  0x000000 :0xffffff);
		}
		else if (value == 512) {
			background = new Color(0xf5e455 + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() < 0x7fffff ?  0x000000 :0xffffff);
		}
		else if (value == 1024) {
			background = new Color(0xf7e12c + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() > 0x7fffff ?  0x000000 :0xffffff);
		}
		else if (value == 2048) {
			background = new Color(0xffe400 + Setting.ShiftColor_tile);
			text = new Color(background.getRGB() > 0x7fffff ?  0x000000 :0xffffff);
		}
		else if(value == 0){
			...
			background = new Color(0x000000 + Setting.ShiftColor_tile);
